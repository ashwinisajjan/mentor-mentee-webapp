$(document).ready(function () {
    ...
    $.ajax(
			 {
				 url:baseUrl+"/getAllStartupApplications",
				 type: 'GET',
				 success : function(result) {
					 ...
					 for (var i in parsedObj) {
						 ...
						 $('#listofapplications').append('<li><a id='+parsedObj[i].startUpName+' href="#">'+parsedObj[i].startupName+'</a></li>');
					 }
				 },
    	...
    	/*$.ajax(
	    	{
	    		 ...
	    		 success : function(result) {
	    			 if (result === undefined || result.length == 0) {
			    		 ...
			    		 var col = [];
			    			for (var i in parsedObj) {
			    				$('#myUL').append('<li><a id='+parsedObj[i].startUpName+' href="#">'+parsedObj[i].startupName+'</a></li>');
			    			} 
	    			 }
	    		 },
	    		 error : function(error) {
